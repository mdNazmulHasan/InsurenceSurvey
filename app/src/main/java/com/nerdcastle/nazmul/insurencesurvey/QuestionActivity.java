package com.nerdcastle.nazmul.insurencesurvey;
...
public class QuestionActivity extends AppCompatActivity {
    ...
    private void showService() throws JSONException {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                "http://dotnet.nerdcastlebd.com/Insurance/api/home", dataForValidation,
        ...
        try {
            if (IsEditable) {
                ...
                if (radioGroup.getCheckedRadioButtonId() != -1) {
                    ...
                    JsonArrayRequest request = new JsonArrayRequest(Request.Method.POST, "http://dotnet.nerdcastlebd.com/Insurance/api/answers",
